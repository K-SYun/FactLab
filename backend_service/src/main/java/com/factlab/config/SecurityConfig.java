        ...
        http
                ...
                .sessionManagement(session -> session
                        .sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                                                .authorizeHttpRequests(auth -> auth
                                                                .requestMatchers(HttpMethod.POST, "/api/news/*/view", "/api/boards/*/view").permitAll()
                                                                .requestMatchers(HttpMethod.GET, "/api/news/**", "/api/boards/**", "/api/posts/**", "/api/comments/**", "/api/trending/**", "/api/popups/**").permitAll()
