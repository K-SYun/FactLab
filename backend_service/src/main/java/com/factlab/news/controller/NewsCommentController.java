...
public class NewsCommentController {
    ...
    public ApiResponse<List<CommentResponseDto>> getNewsComments(
        ...
        try {
            List<CommentResponseDto> comments = commentService.getNewsComments(newsId);
    ...
    public ApiResponse<CommentResponseDto> createNewsComment(
        ...
        try {
            ...
            CommentResponseDto comment = commentService.createNewsComment(createDto, userId);
